...
class TestDepartmentsController(BaseTestCase):
    """DepartmentsController integration test stubs"""
    ...
    def test_add_department(self):
        ...
        Add Department
        """
        department = "{'department_name': 'Example', 'manager_id': 1, 'company_id': 2 }"
        headers = { 
    ...
    def test_delete_department(self):
        ...
        response = self.client.open(
            '/api/v0/departments/{id}'.format(id='id_example'),
            method='DELETE',
            headers=headers)
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
    ...
    def test_patch_department(self):
        """Test case for patch_department
